...
for epoch in range(epochs):
    ...
    if epoch%2==0:
        torch.save(model.state_dict(), os.path.join(args.results_dir,'own_data_fingermodel_mv3_bal_{}_{}.pth'.format(args.lr, epoch)))
...
plt.savefig(os.path.join(args.results_dir,'results_{}_{}.png'.format(args.lr, args.epochs)))
